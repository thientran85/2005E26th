				...
				<!-- Intro -->
					<section id="top" class="one">
						<div class="container">
							...
							<header>
								<h3 class="alt">Thinking about selling <span class="blackblock"> 2005 E 26th St?</span> Let us help! Team Fast Agents is YOUR personal team of professionals who makes Real Estate <span class="blueblock">EASY</span> for <span class="greenblock">YOU.</span></h3>
							</header>
					...
					<section id="about" class="three">
						<div class="container">
							<header>
								...
								<h3 style="color: #ecf0f1;">Properties sold within area of 2005 E 26th St</h3>
							</header>
							<div class="row">
								<div class="4u">
									<article class="item">
								...
								<div class="4u">
									<article class="item">
										...
										<ul>
											...
											<li>List: 5/14/13 - Sold: 7/23/13</li>
								...
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>1373 E 32nd St</strong></h3>
										<ul>
											<li>3 Bed - 2 Bath</li>
											<li>1,298 Sq Ft - 3,800 Lot</li>
											<li>List: 8/23/13 - Sold: 9/19/13</li>
											<li>List: $375,000 - SOLD $385,000</li>
										</ul>
									</article>
								</div>
							</div>
							<br />
							<a href="http://maxebrdi.paragonrels.com/publink/default.aspx?GUID=e8b915ce-8e2d-4cba-bcb7-2547144fe067&Report=Yes" class="image full"><img style="width: 100%;" src="images/compdata.jpg" /></a>
						</div>
					</section>
